            ...
            <div class="relative bg-white rounded-lg border border-black shadow ">
                ...
                <form action="{{route('tarea.store')}}" method="POST" class="p-4 md:p-5">
                    ...
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2">
                            <label for="description" class="block mb-2 text-sm font-medium text-black">Descripcion</label>
                            <textarea id="descripcion" name="descripcion" type="text" value="{{old('descripcion')}}" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Write product description here"></textarea>
                        </div>
                    </div>
